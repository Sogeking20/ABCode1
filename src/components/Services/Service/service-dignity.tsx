        ...
        <div className="border-1px p-[30px] bg-[url('https://creonit.ru/images/blue-bg.webp')] bg-no-repeat bg-cover rounded-3xl">
          ...
          <div className="why-we-are-item__information">
            <div className="text-[hsla(0, 0%, 100%, .8)]">
              <p>
                Специалисты ABCode имеют достаточно опыта, чтобы создавать
                веб-приложения согласно установленным требованиям и срокам. За
                каждым отдельным проектом закреплен опытный руководитель,
                уровень которого не ниже Middle+. Мы контролируем ход разработки
                и оперативно реагируем на любые&nbsp; проблемные ситуации.
              </p>
            </div>
          </div>
        </div>

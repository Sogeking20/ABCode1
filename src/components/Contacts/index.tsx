      ...
      <Container>
        <div className="grid-contacts">
          <div className="w-full flex justify-between">
            <div className=" sm:max-w-[356px] w-[100%] max-h-[256px] bg-[#ebf1ff] rounded-3xl p-[24px] flex flex-col gap-5">
              <div className="">
          ...
          <div className="w-[100%] py-[50px] md:py-[90px] mb-[50px] px-[30px] bg-[url('https://creonit.ru/images/blue-bg.webp')] bg-no-repeat bg-cover text-white rounded-3xl">
            <div className="text-[28px] md:text-[36px]">

      ...
      <Container>
        <div className="flex flex-col items-center text-center mb-[100px]">
          ...
          <p className="text-[20px] text-[#808080] mb-[20px]">
            В данном разделе представлена стоимость услуг компании MediaTen.
            Чтобы оценить все достоинства и бесплатно протестировать наши
            возможности, напишите нам. Мы ответим на интересующие вопросы и
            составим план по решению ваших задач.
          </p>
